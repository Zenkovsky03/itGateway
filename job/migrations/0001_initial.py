# Generated by Django 5.0.3 on 2024-05-03 20:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(choices=[('Business', 'Business'), ('Information Technology', 'It'), ('Banking', 'Banking'), ('Education/Training', 'Education'), ('Telecommunication', 'Telecommunication'), ('Other', 'Other')], default='Business', max_length=50)),
                ('experience', models.CharField(choices=[('No Experience', 'No Experience'), ('1 year', 'One Year'), ('2 years', 'Two Year'), ('3 years above', 'Three Years Plus')], default='No Experience', max_length=50)),
